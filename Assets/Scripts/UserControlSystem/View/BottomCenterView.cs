    ...
    public void SetTask(IUnitProductionTask task, int index)
    {
        ...
        else
        {
            ...
            if(index == 0)
            {
                ...
                _unitProductionTaskCt =
                    Observable
                        .EveryUpdate()
                        .Subscribe(_ => _productionProgressSlider.value = task.TimeLeft / task.ProductionTime);
            };
        };
    }

    private void DisableCurrentProductionUI()
    {
